        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            <header className="mb-12">
              ...
              <div className="flex flex-wrap items-center gap-4 text-zinc-400">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full transition-colors"
                >
            ...
            {repo.topics && repo.topics.length > 0 && (
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-zinc-50 mb-4">Topics</h3>

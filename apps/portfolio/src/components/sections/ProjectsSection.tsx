        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {defaultProjects.map((project) => (
            <a
              ...
              className="project-card group block p-8 rounded-2xl bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 hover:border-indigo-500/50 transition-all duration-300"
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                <h3 className="text-xl font-semibold text-zinc-50 group-hover:text-indigo-400 transition-colors">
                  {project.name}
                </h3>
                {project.language && (
                  <span
